                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <select class="form-control selectpicker" data-live-search="true" id="category">
                                    ...
                                    <option value="{{ $category->id }}"@if($announcement->category->id == $category->id)selected @endif >{{ $category->designation }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="form-group">
                                <select class="form-control selectpicker"  data-live-search="true" id="type">
                                    ...
                                    <option value="0" @if($announcement->type == 0) selected @endif >Vente </option>
                                    <option value="1" @if($announcement->type == 1) selected @endif>Location</option>
                                </select>
                            </div>
                        </div>
...
<script>
    $( "#btn-go" ).click(function() {
                ...
                var type = $( "#type" ).val();
                var  id = $( "#announcement" ).val();
                window.location.replace('/app/edit-announcement-step-two/'+ category +'/'+type + '/' +id);
            });
</script>
@endpush
