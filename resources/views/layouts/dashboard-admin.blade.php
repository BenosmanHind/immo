    ...
    ***********************************-->
    <div id="main-wrapper">
				...
				<li class="nav-label first">Main Menu</li>
                        ...
                        <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                            ...
                            <ul aria-expanded="false">
                                <ul aria-expanded="false">
                                       <li><a href="{{url('/admin/customers')}}">Clients</a></li>
                                </ul>

                            </ul>
                        </li>
                    <li class="nav-label">Catégories</li>
                    <li><a href="{{ url('/admin/categories') }}" class="ai-icon" href="javascript:void()" aria-expanded="false">
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="svg-main-icon">
                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                    ...
                    <li class="nav-label">Annonces</li>
                    <li><a href="{{ url('/admin/announcements') }}" class="ai-icon" href="javascript:void()" aria-expanded="false">
						<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="svg-main-icon">
                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                <rect x="0" y="0" width="24" height="24"/>
                    ...
                    <li class="nav-label">Commentaires</li>
                    <li><a href="{{ url('/admin/comments') }}" class=" ai-icon" href="javascript:void()" aria-expanded="false">
						<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="svg-main-icon">
                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                <rect x="0" y="0" width="24" height="24"/>
        ...
        ***********************************-->
        <div class="footer">
            <div class="copyright">
                <p>Copyright © Designed &amp; Developed by <a href="http://dexignzone.com/" target="_blank">Immo+</a> 2023</p>
            </div>
        </div>
        <!--**********************************
            Footer end
